...
// Manually build a view matrix
// p, Camera position
// u, Up vector
// lookAt, look at center
// Make sure r, u and d make a left-hand coordinate system after calculation
// the order to calculate u and r is not matter.
D3DXMATRIX buildViewMatrix(D3DXVECTOR3& p, D3DXVECTOR3& u, D3DXVECTOR3& lookAt)
{
	// Calculate d, d is the look at direction(view sight), you can think it as the z-axis
	D3DXVECTOR3 d = lookAt - p;
	D3DXVec3Normalize(&d, &d);

	// Calculate r, r is the right vector, you can think it as the x-axis
	D3DXVECTOR3 r;
	D3DXVec3Cross(&r, &u, &d);
	D3DXVec3Normalize(&r, &r);

	// Calculate up, up is the up vector, you can think it as the y-axis
	D3DXVec3Cross(&u, &r, &d);
...
void SetupMatrix()
{
	...
	//D3DXMATRIX view = buildViewMatrix(eyePt, upVec, lookCenter);
