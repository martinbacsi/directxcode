...
LPD3DXMESH GenerateSphereMesh(LPDIRECT3DDEVICE9 pDev, float fRadius, UINT slices, UINT stacks) ;
...
HRESULT InitD3D( HWND hWnd )
{
	...
	g_pMesh = GenerateSphereMesh(g_pd3dDevice, 1.0f, 30, 30) ;

	HRESULT hr = D3DXCreateTextureFromFile(g_pd3dDevice, "../Common/Media/test.jpg", &g_pTexture) ;
	if (FAILED(hr))
	{
