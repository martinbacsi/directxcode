/*
This demo does not work, I set all the state of the light in the effect file
but I don't see any color of the teapot
*/
...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	winClass.lpszClassName = "Point Light";
