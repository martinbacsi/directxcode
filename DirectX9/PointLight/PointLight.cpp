/*
This demo show how to use point light in D3D

Key steps:
1. Create a teapot
2. Create material and set it, you MUST ZeroMemory material before using it!!!
...
3. The material defines which color the model will reflect, so, we often set up 
...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	winClass.lpszClassName = "PointLight";
