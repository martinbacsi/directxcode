...
LRESULT WINAPI MsgProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
	...
	case WM_KEYDOWN:
		{
			...
			case 'S':
				//ScreenShot(g_pd3dDevice, hWnd, L"Screenshot.bmp");
				break ;
	...
	case WM_LBUTTONUP:
		...
		ScreenShot(g_pd3dDevice, NULL, L"aaa.jpg") ;
		break ;
