/*
This demo show how to build the projection matrix manually
Please see function BuildProjectionMatrix for details
The theory for how to build the projection matrix is here
