...
IDirect3DVertexDeclaration9* vertex_declare;
...
HRESULT CreateCube()
{
	...
	g_pd3dDevice->CreateVertexDeclaration(VertexPNElements, &vertex_declare);
...
{
	// Set texture
	D3DXCreateTextureFromFile(g_pd3dDevice, L"../Common/Media/crate.jpg", &g_pCubeTexture) ;
	...
	g_pd3dDevice->SetVertexDeclaration(vertex_declare);
