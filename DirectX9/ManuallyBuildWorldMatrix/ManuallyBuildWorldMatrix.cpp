/*
This demo is used to show how to build the geometry transform matrix without using DX functions
We simulate 3 kinds of transformation: translation, rotation, scaling
*/
