/*
This demo show how to use only material in D3D
In D3D, if you use light, you must use material, but you can use only material without lighting

Note:
1. YOU MUST ZeroMemory material variables before using it! otherwise you will see nothing.
D3DMATERIAL9 material;
ZeroMemory(&material, sizeof(material));

2. Lighting must be enabled, material.Emissive, This component is used to add to the overall color of the surface, 
