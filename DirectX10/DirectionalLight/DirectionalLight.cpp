/*
Description:  This demo show you how to Create directional light in DirectX10
Date: 2013-07-09
Author: zdd
*/
...
VOID InitEffects()
{
    ...
    HRESULT hr = D3DX10CreateEffectFromFile( L"directional_light.fx", NULL, NULL, "fx_4_0", dwShaderFlags, 0,
...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	winClass.lpszClassName = L"Directional Light";
	...
	HWND hWnd = CreateWindowEx(NULL,  
		...
		L"Directional Light",				// window caption
