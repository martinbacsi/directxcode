/*
Description:  This demo show you how to Create point light in Direct3D 10
Date: 2013-07-25
Author: zdd
*/
...
VOID InitLight()
{
    ...
    // g_Light.dir = D3DXVECTOR3(0.57735f, -0.57735f, 0.57735f);
	g_Light.pos = D3DXVECTOR3(15.0f, 15.0f, 15.0f);
	g_Light.range = 100.0f;
	g_Light.att.x = 0.0f;
	g_Light.att.y = 0.05f;
	g_Light.att.z = 0.0f;
	g_Light.ambient = D3DXCOLOR(0.5f, 0.5f, 0.0f, 1.0f);
...
VOID InitEffects()
{
    ...
    HRESULT hr = D3DX10CreateEffectFromFile( L"point_light.fx", NULL, NULL, "fx_4_0", dwShaderFlags, 0,
...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	winClass.lpszClassName = L"Point Light";
