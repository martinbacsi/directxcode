...
HRESULT InitD3D( HWND hWnd )
{
	...
	InitEffects();
	InitRasterState();
	CreateTextureInMemory(128, 128, 0xff123477);
...
VOID CreateTextureInMemory(int texWidth, int texHeight, DWORD color)
{
	...
	hr = g_pd3dDevice->CreateShaderResourceView(g_pTexture, &srvDesc, &g_pTextureRV);
	if (FAILED(hr))
	{
...
VOID InitEffects()
{
    ...
    HRESULT hr = D3DX10CreateEffectFromFile( L"create_texture_manually.fx", NULL, NULL, "fx_4_0", dwShaderFlags, 0,
...
INT WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR szCmdLine, int iCmdShow)
{
	...
	winClass.lpszClassName = L"Create texture manuall";
	...
	HWND hWnd = CreateWindowEx(NULL,  
		...
		L"Create texture manually",	// window caption
