/*
This demo show you how to transform one object of multiple objects

1. Get the old transform matrix by call rendertarget->GetTransform()
2. Set current transform
3. Restore the old transform
...
VOID DrawRectangle(HWND hwnd)
{
	...
	// Get the old render target transform matrix
	D2D1_MATRIX_3X2_F oldMatrix;
	g_pRenderTarget->GetTransform(&oldMatrix);
	...
	g_pRenderTarget->SetTransform(&oldMatrix);
	g_pRenderTarget->DrawRectangle(
